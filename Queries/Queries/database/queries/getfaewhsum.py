...
#----------------------------------------------------------------------
def GetFaeWhSum(db,region,weeks):
  ...
  for i in range(len(weeks)):
    ...
    sqltxt[6] = '  (ts.entry_date >= ? and ts.entry_date <= ?)'
    ...
    weekList.append((data,hc,weekNum,am_days,uk_days,fr_days,de_days,fi_days,se_days,gc_days))
