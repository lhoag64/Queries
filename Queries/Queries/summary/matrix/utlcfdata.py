...
from   database.queries.getutlcfsum import GetUtlCfSum
...
#----------------------------------------------------------------------
  def __init__(self,region,mType,period):
    ...
    dataList = GetUtlCfSum(Db.db,regionList,weekDict)
    ...
    super().calcTitle('Utilisation (On Customer Funded Works)',regionList,period)
